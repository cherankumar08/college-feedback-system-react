...
const LinearScaleQuestion = ({
  ...
  return (
    <div className={`question-1 qn-check-T2 question-${questionNumber}`}>
      ...
      <div
        id={`linear-scale-T2-${questionNumber}`}
        ...
        {options.map((option, index) => (
          ...
          <div key={index} className="linear-scale-qn">
            ...
            <label
              ...
              htmlFor={`Overall_Tab-2-qn-${questionNumber}-rating${questionNumber}_${
                index + 1
              }`}
            >
              {option.label}
            ...
            <input
              type="radio"
              name={`Overall_Tab-2-rating-${questionNumber}-qn-${questionNumber}`}
              value={option.value}
              id={`Overall_Tab-2-qn-${questionNumber}-rating${questionNumber}_${
                index + 1
              }`}
            />
          </div>
  ...
  return (
    <div>
      ...
      <div className="Question-bor">
        ...
        <SubmissionButton TabNo="2" SurveyName="Overall Experiences" />
      </div>
    </div>
  );
};

export default OverallTwo;
