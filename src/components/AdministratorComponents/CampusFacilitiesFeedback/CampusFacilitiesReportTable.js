...
const CampusFacilitiesReportTable = () => {
    const navigationLinks = [
      { label: "Student", to: "facilities-student" },
      { label: "Faculty", to: "facilities-faculty" },
      { label: "Staff", to: "facilities-staff" },
    ];
  const data = {
    columns: [
...
export default CampusFacilitiesReportTable;
