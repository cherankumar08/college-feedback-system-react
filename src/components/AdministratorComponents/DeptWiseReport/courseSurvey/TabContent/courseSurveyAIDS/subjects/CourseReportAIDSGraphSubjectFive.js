...
// const CourseReportAIDSGraphSubjectFive = () => {
...
// export default CourseReportAIDSGraphSubjectFive;
...
const CourseReportAIDSGraphSubjectFive = () => {
  ...
  const chartRef = useRef(null);
  const chartData = useSelector((state) => state.data.data[4]); // Access the third dataset
