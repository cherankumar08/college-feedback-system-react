...
// const CourseReportAIDSGraphSubjectTwo = () => {
...
// export default CourseReportAIDSGraphSubjectTwo;
...
const CourseReportAIDSGraphSubjectTwo = () => {
  ...
  const chartRef = useRef(null);
  const chartData = useSelector((state) => state.data.data[1]); // Access the third dataset
