...
// const CourseReportAIDSGraphSubjectThree = () => {
...
// export default CourseReportAIDSGraphSubjectThree;
...
const CourseReportAIDSGraphSubjectThree = () => {
  ...
  const chartRef = useRef(null);
  const chartData = useSelector((state) => state.data.data[2]); // Access the third dataset
