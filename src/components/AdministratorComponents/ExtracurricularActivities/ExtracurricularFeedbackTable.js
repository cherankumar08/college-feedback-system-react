...
const ExtracurricularFeedbackTable = () => {
  const navigationLinks = [
    { label: "Student", to: "extra-student" },
    { label: "Faculty", to: "extra-faculty" },
    { label: "Staff", to: "extra-staff" },
  ];
  const data = {
    columns: [
...
export default ExtracurricularFeedbackTable;
