...
const ServicesFeedbackTable = () => {
  const navigationLinks = [
    { label: "Student", to: "services-student" },
    { label: "Faculty", to: "services-faculty" },
    { label: "Staff", to: "services-staff" },
  ];
  const data = {
    columns: [
...
export default ServicesFeedbackTable;
