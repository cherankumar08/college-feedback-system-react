...
const SuggestionSurveyCreation = () => {
  ...
  const addNewQuestion = () => {
    ...
    fetch("http://localhost:5000/surveyOnSuggestion ", {
      method: "POST",
      headers: {
  ...
  const handlePublish = () => {
    ...
    // If all questions are filled, proceed with publishing
    console.log("Inside handlePublish:", questions);
  ...
  return (
    <div>
      <SurveyTitles
        ...
        SubjectName="Survey on Suggestions and Improvements"
      />
      <CascadingDropdown />
...
export default SuggestionSurveyCreation;
