...
const ExtracurricularCreation = () => {
  ...
  const addNewQuestion = () => {
    ...
    fetch("http://localhost:5000/extracurricularActivities ", {
      method: "POST",
      headers: {
  ...
  return (
    <div>
      <SurveyTitles
        ...
        SubjectName="Extracurricular Activities"
      />
      <CascadingDropdown />
...
export default ExtracurricularCreation;
