...
const StudentSurvey = () => {
  ...
  const addNewQuestion = () => {
    ...
    fetch("http://localhost:5000/coursequestions ", {
      method: "POST",
      headers: {
  ...
  return (
    <div>
      <SurveyTitles
        ...
        SubjectName="Course Survey"
      />
      <CascadingDropdown />

      {/* <div className="ms-5 d-flex justify-content-center">
        <div className="d-flex flex-column align-items-center justify-content-center my-3 col-5 ms-5 col-sm-12">
          <h5 htmlFor="" className="required label-date text-left">
            Select the End Time
          </h5>
