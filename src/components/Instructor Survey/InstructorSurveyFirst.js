...
const InstructorSurveyFirst = () => {
  ...
  return (
    <div>
      <SurveyTitles SubjectName="Professor Jane" SubjectFaculty={null} />
      {questions
...
export default InstructorSurveyFirst;
