...
const InstructorSurveySecond = () => {
  ...
  return (
    <div>
      <SurveyTitles SubjectName="Professor David Lee" SubjectFaculty={null} />
      {questions
        ...
        .map((course) => (
          <div key={course.id}>
            <LinearScaleQuestion
              ...
              start={5}
              currentSubject="Professor David Lee"
...
export default InstructorSurveySecond;
