...
const FacultySuggestionT1 = () => {
  return (
    <div>
      <div class="question bor-ques">
        <SurveyTitle SurveyTitle="Infrastructure Development" />

        <div class="question-1 question-1 OverAll-T1 Question-bor">
          <p>
        ...
        <div class="question-1 question-2 OverAll-T1 Question-bor">
          <p>
        ...
        <div class="question-1 question-3 OverAll-T1 Question-bor">
          <p>
        ...
        <div class="question-1 question-4 OverAll-T1 Question-bor">
          <p>
        ...
        <div class="question-1 question-5 OverAll-T1 Question-bor">
          <p>
...
export default FacultySuggestionT1;
