    ...
    <div className="d-flex justify-content-center ms-3">
      <div className=" ms-1 mt-2">
        <div className="container mb-3">
            {/* Profile Title */}
          <SurveyTitle SurveyTitle="Staff Profile" />
          ...
          <Form className="">
            <Row className="mb-3">
              ...
              <Form.Group
                ...
                className="text-left mt-2 mb-2"
              >
                <Form.Label className="Label-lft h5">Staff Name</Form.Label>
...
export default StaffDetailsProfile;
