...
export const deleteQuestion = createAsyncThunk(
  "extracurricularActivities/deleteQuestion",
  async (questionId) => {
    await axios.delete(`http://localhost:5000/extracurricularActivities/${questionId}`);
    return questionId;
  }
);
...
export const updateQuestion = createAsyncThunk(
  "extracurricularActivities/updateQuestion",
  async (updatedQuestion) => {
    for (let id in updatedQuestion) {
      await axios.patch(`http://localhost:5000/extracurricularActivities/${id}`, {
...
export const fetchCourseQuestions = createAsyncThunk(
  "extracurricularActivities/fetchCourseQuestions",
  async () => {
    const response = await fetch("http://localhost:5000/extracurricularActivities");
