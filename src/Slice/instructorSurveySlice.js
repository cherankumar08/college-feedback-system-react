// Redux slice (instructorSurveySlice.js)
  ...
  async (surveyData, thunkAPI) => {
    try {
      ...
      const response = await axios.post(
        "http://localhost:5000/instructorquestions ",
        surveyData
      );
...
export const { addQuestion, updateQuestion, setError } = instructorSurveySlice.actions;
