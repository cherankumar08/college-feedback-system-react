...
const BASE_URL = "http://localhost:5000/Faculty";

// GET THUNK ACTION
export const getStudentFromServer = createAsyncThunk(
  "FacultyDetails/getStudentFromServer",
  // Callback Function
...
export const AddDetailsToServer = createAsyncThunk(
  "FacultyDetails/AddDetailsToServer",
  // Callback Function
...
export const UpdateDetailsToList = createAsyncThunk(
  "FacultyDetails/UpdateDetailsToList",
  // Callback Function
  async (details, { rejectWithValue }) => {
    const options = {
      method: "PATCH",
...
export const DeleteDetailFromServer = createAsyncThunk(
  "FacultyDetails/DeleteDetailFromServer",
  // Callback Function
  async (details, { rejectWithValue }) => {
    const options = {
      method: "DELETE",
